...
RTL_FREQ=748.67e6 # (MONITOR + 250 - offset=0.08)*1e6

MONITOR_SYM_RATE=250e3 # 2MS/s, 1MS/s, 500kS/s, 333kS/s, 250kS/s
RTL_SAMPLE_RATE=1152000 # 1152000, 1200000, 1440000, 1600000, 1800000, 1920000, 2400000=2.4M samp/s, 2880000, 3200000
